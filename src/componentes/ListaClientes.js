// src/componentes/ListaClientes.js
//Presenta los datos despues de la obtención.
//Recibe los datos de los clientes como prop.........
//useState se utiliza para paginación y el buscador
import React, { useState } from 'react';

const ListaClientes = ({ clientes, handleEditar, handleEliminar }) => {
    /* FUNCIÓN NUEVAS IMPLEMENTADAS*/
                ...
                <tbody className="text-center">
                    {datosPaginados.map(cliente => (
                        <tr key={cliente.id_clie}>
                            ...
                            <td>
                                {/* Botón de editar que llama a la función "onEditar" con los datos del cliente */}
                                <button
                            ...
                            <td>
                                {/* Botón de eliminar que llama a la función "onEliminar" con los datos del cliente */}
                                <button
